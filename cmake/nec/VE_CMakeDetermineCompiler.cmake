...
macro(ve_init_compiler LANG COMPILER EXTENSIONS PREFERENCE)
	if(NOT CMAKE_VE_PATH)
		set(CMAKE_VE_PATH "/opt/nec/ve")
	endif()

	set(COMPILER_PATH "/opt/nec/ve")
	if(LANG STREQUAL "VEDA_Fortran")
		if(CMAKE_NFORT_PATH)
			set(COMPILER_PATH ${CMAKE_NFORT_PATH})
		endif()
	else()
		if(CMAKE_NCC_PATH)
			set(COMPILER_PATH ${CMAKE_NCC_PATH})
		endif()
	endif()

	if(NOT CMAKE_${LANG}_COMPILER)
		find_file(CMAKE_${LANG}_COMPILER ${COMPILER} PATHS ${COMPILER_PATH}/bin NO_DEFAULT_PATH )
		find_file(CMAKE_${LANG}_COMPILER_AR nar PATHS ${CMAKE_VE_PATH}/bin NO_DEFAULT_PATH )
		find_file(CMAKE_${LANG}_COMPILER_RANLIB nranlib PATHS ${CMAKE_VE_PATH}/bin NO_DEFAULT_PATH )
