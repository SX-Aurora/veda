...
VEDAresult vedaCtxDestroy(VEDAcontext ctx) {
	...
	GUARDED(
		veda::internal::contexts::remove(ctx);
		ctx->destroy();
	)
}
...
VEDAresult vedaCtxGetCurrent(VEDAcontext* pctx) {
	GUARDED(
		*pctx = veda::internal::contexts::current();
...
VEDAresult vedaCtxGetDevice(VEDAdevice* device) {
	GUARDED(
		...
		*device = veda::internal::contexts::current()->device().vedaId();
...
VEDAresult vedaCtxPopCurrent(VEDAcontext* pctx) {
	GUARDED(
		*pctx = veda::internal::contexts::pop();
...
VEDAresult vedaCtxPushCurrent(VEDAcontext ctx) {
	...
	GUARDED(
		...
		veda::internal::contexts::push(ctx);
	)
}
...
VEDAresult vedaCtxSetCurrent(VEDAcontext ctx) {
	...
	GUARDED(
		...
		veda::internal::contexts::set(ctx);
	)
}
...
VEDAresult vedaCtxCreate(VEDAcontext* pctx, int mode, VEDAdevice dev) {
	GUARDED(
		*pctx = &veda::internal::devices::get(dev).ctx();
		...
		veda::internal::contexts::push(*pctx);
	)
}
/** @} */
//------------------------------------------------------------------------------
