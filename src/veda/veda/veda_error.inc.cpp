VEDAresult vedaGetErrorName(VEDAresult error, const char** pStr) {
	switch(error) {
		...
		case VEDA_ERROR_UNKNOWN_CALLBACK:			*pStr = "VEDA_ERROR_UNKNOWN_CALLBACK";				return VEDA_SUCCESS;
		case VEDA_ERROR_CALLBACK_ALREADY_REGISTERED:		*pStr = "VEDA_ERROR_CALLBACK_ALREADY_REGISTERED";		return VEDA_SUCCESS;
		case VEDA_ERROR_MEMORY_MISALIGNED:			*pStr = "VEDA_ERROR_MEMORY_MISALIGNED";				return VEDA_SUCCESS;
		case VEDA_ERROR_UNKNOWN_VEDA_ARCHITECTURE:		*pStr = "VEDA_ERROR_UNKNOWN_VEDA_ARCHITECTURE";			return VEDA_SUCCESS;
		case VEDA_ERROR_CANT_RELEASE_NON_DELAYED_VPTR:		*pStr = "VEDA_ERROR_CANT_RELEASE_NON_DELAYED_VPTR";		return VEDA_SUCCESS;
		case VEDA_ERROR_CANT_RELEASE_ALREADY_RELEASED_VPTR:	*pStr = "VEDA_ERROR_CANT_RELEASE_ALREADY_RELEASED_VPTR";	return VEDA_SUCCESS;
		case VEDA_ERROR_CANT_FREE_NON_DELAYED_VPTR:		*pStr = "VEDA_ERROR_CANT_FREE_NON_DELAYED_VPTR";		return VEDA_SUCCESS;
		case VEDA_ERROR_CANT_RELEASE_NON_DEVICE_ALLOCATED_VPTR:	*pStr = "VEDA_ERROR_CANT_RELEASE_NON_DEVICE_ALLOCATED_VPTR";	return VEDA_SUCCESS;
		case VEDA_ERROR_OVERRIDE_ALREADY_SET:			*pStr = "VEDA_ERROR_OVERRIDE_ALREADY_SET";			return VEDA_SUCCESS;
	}
