...
int main()
{
	...
	printf("\nTEST CASE ID: FT_VEDA_HMEM_D2D_08 vedaHMemsetD2D64\n");
	...
	CHECK(vedaHMemsetD2D64(hmemptr_2d, pitch_size, value1, w, h));
	...
	printf("\nTEST CASE ID: FT_VEDA_HMEM_D2D_09 vedaHMemsetD2D64Async\n");
	int64_t value2 = (int64_t)0x123456789012345;
	CHECK(vedaMemsetD64(ptr_2d, 0x00, SIZE/sizeof(int64_t)));
	CHECK(vedaHMemsetD2D64Async(hmemptr_2d, pitch_size, value2, w, h, 0));
	CHECK(vedaHMemcpyXtoD(ptr_2d, hmemptr_2d, sizeof(int64_t) *w*h));
